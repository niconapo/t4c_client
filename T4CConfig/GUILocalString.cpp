...
*/
{
   ...
   if(dwLanguage == 0)
      sprintf_s( lngFile,256, "EnglishGUI.elng");
   else if(dwLanguage == 1)
      sprintf_s( lngFile,256, "FrenchGUI.elng");
   else if(dwLanguage == 2)
      sprintf_s( lngFile,256, "GermanGUI.elng");
   else
      sprintf_s( lngFile,256, "EnglishGUI.elng");
...
void GUILocalString::CannotParse(void) 
{
   ...
   sprintf_s(LanguageString[0],250, "Error in parsing file: [Language].elng");
   dwStringNb = 1;
}