...
//////////////////////////////////////////////////////////////////////////////////////////
V3_ChestDlg *V3_ChestDlg::GetInstance( void )
//////////////////////////////////////////////////////////////////////////////////////////
//  Returns the side menu instance.
//////////////////////////////////////////////////////////////////////////////////////////
{

    static V3_ChestDlg instance;
    return &instance;
...
//////////////////////////////////////////////////////////////////////////////////////////
unsigned int V3_ChestDlg::Display( void *null )
{
   ...
   {
      GetInstance()->m_iXPos = g_Global.GetDialogChestLastXPos();
      GetInstance()->m_iYPos = g_Global.GetDialogChestLastYPos();
...
void V3_ChestDlg::UpdateAllFramePos(int iPosX,int iPosY)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
void V3_ChestDlg::Draw(V2SPRITEFX *vsfFX)
{
   if(!IsShown())
      return;
...
void V3_ChestDlg::StartDragDlg( MousePos mousePos )
{
...
///////////////////////////////////////////////////////
void V3_ChestDlg::DragEvent::LeftClicked( void )
{
   V3_ChestDlg *me = static_cast< V3_ChestDlg * >( GetUI() );
   
   me->StopDragDlg();
}

void V3_ChestDlg::DragEvent::StartDragLButtonDown( int mX, int mY )
{
   V3_ChestDlg *me = static_cast< V3_ChestDlg * >( GetUI() );
...
void V3_ChestDlg::AskValueReturnSld(bool bOK,UINT uiShowCodeP,char *pStrValue1,int iSldVal)
{
   if(!bOK || iSldVal == 0)
      return;
...
// Updates the chest
void V3_ChestDlg::UpdateChest( TemplateList< BAG_ITEM > *newChest )
{
   ...
   tlChest.Lock( "V3_ChestDlg::UpdateChest" );
   newChest->Lock( "V3_ChestDlg::UpdateChest" );
   ...
   tlChest.Unlock("V3_ChestDlg::UpdateChest");
   newChest->Unlock("V3_ChestDlg::UpdateChest");
}

void V3_ChestDlg::Reload()
{
   LoadChest();
   inventoryGrid          =  &(V3_InvDlg::GetInstance()->inventoryGrid) ;
   invGridScrollDownGraph =  &(V3_InvDlg::GetInstance()->gridScrollDownGraph) ;
...
BOOL V3_ChestDlg::UpdateItemsName(DWORD dwItemID,LPBYTE lpbItemName)
{
   BOOL returnValue = FALSE;
   tlChest.Lock("V3_ChestDlg::UpdateItemsName");
   tlChest.ToHead();
   while (tlChest.QueryNext()) 
   {
      ...
      if( lpBagItem->dwID == dwItemID )
      {
         ...
         if( lpBagItem->associatedUI != NULL )
         {
            ...
            static_cast< V3_ChestDlg::ItemUI * >( lpBagItem->associatedUI )->UpdateName2();
         }
         returnValue = TRUE;
         break;
      }
   }
   tlChest.Unlock("V3_ChestDlg::UpdateItemsName");
  	return returnValue;
}

// Virtual key inputs
bool V3_ChestDlg::VKeyInput(VKey vKey)
{
...
//  Setups the given item UI according to its binded BAG_ITEM data.
void V3_ChestDlg::RequestMoveItemFromChestToBackpack(DWORD dwItemID,DWORD dwQty)
{
   TFCPacket packet;
...
//  Setups the given item UI according to its binded BAG_ITEM data.
void V3_ChestDlg::RequestMoveItemFromBackpackToChest(DWORD dwItemID,DWORD dwQty)
{
   TFCPacket packet;
...
void V3_ChestDlg::ChestToSave( void )
{
   CAutoLock theLock( RootBoxUI::GetInstance()->GetLock() );
...
void V3_ChestDlg::LoadChest( void )
{
   ...
   if(dwNbrChest > 0)
   {
      ...
      {
         sInventory *pNewChest = g_SaveGame.GetChest(i);
...
void V3_ChestDlg::ChestGridEvent::Dragged( void )
{
   ItemUI *item;
   if( GetDragItem() == NULL )
   {
...
bool V3_ChestDlg::ChestGridEvent::Dropping( void )
{
   ...
   {        
      V3_ChestDlg *me = V3_ChestDlg::GetInstance();
