...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( text != NULL ){
        ...
        if( center ){
            ...
            text->Draw( 
                GetPos().Width()  / 2 - text->GetWidthTO()  / 2 + GetPos().x,
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( text == NULL )
    {
       ...
       if(iFontSize == 3)
         text = FontManager::GetInstance()->GetMiddleFontT4C(); 
       else if(iFontSize == 2)
          text = FontManager::GetInstance()->GetSmallestFont();
       else if(iFontSize == 1)
          text = FontManager::GetInstance()->GetMiddleFont(); 
       else
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( text->GetWidthTO() <= (int)maxSize ){
        return;
    }
    ...
    DWORD width = text->GetWidthTO( str.c_str() );
    while( width > maxSize ){
        if( str.size() <= 4 ){
            text->ResetText( "..." );            
            return;
        ...
        width = text->GetWidthTO( str.c_str() );
    }
