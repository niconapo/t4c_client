...
public:
    ...
    virtual void AskValueReturn(bool bOK,UINT uiShowCodeP,char *pStrValue1,char *pStrValue2,VKey vKey);
    virtual void AskValueReturnSld(bool bOK,UINT uiShowCodeP,char *pStrValue,int iSldVal);
    virtual void ConfirmReturn(bool bOK,UINT uiShowCodeP);
    virtual void ComboReturn(UINT uiShowCodeP,char *pStrValue);
    virtual void SmileReturn(UINT uiSmileID);
