// V3_RTMapDlg.cpp: implementation of the V3_RTMapDlg class.
//
//////////////////////////////////////////////////////////////////////
#include "../pch.h"
...
#define RT_VIEW_X  638
#define RT_VIEW_Y  404
...
V3_RTMapDlg::V3_RTMapDlg()
{
   // Setup the chatter channel
   int dwX = (g_Global.GetScreenW()-RT_VIEW_X)/2;
   int dwY = ((g_Global.GetScreenH()-RT_VIEW_Y)/2)-(g_MainBarDlgH/2);
   if(dwY <0)
       dwY =0;
   ...
   sprintf_s(m_RTFile,512,"%s%s",strPath,"\\Game Files\\RT_Map.dat");
   sprintf_s(m_RTFileC,512,"%s\\%s%s",strPath,Player.ServerName,"\\Game Files\\RT_Map.dat");
   ...
   m_MainMapPPos  .SetPos( FramePos(dwX+263,dwY+145, dwX+263+116,dwY+145+113 ) );
...
unsigned int V3_RTMapDlg::Display( void *null)
{
...
void V3_RTMapDlg::LoadRTWorld(int iWorld,int dwX,int dwY)
{
   ...
   FILE *pf1 = NULL;
   fopen_s(&pf1,m_RTFileC,"rb");
   if(pf1 == NULL)
      fopen_s(&pf1,m_RTFile,"rb");
   if(!pf1)
   {
...
//////////////////////////////////////////////////////////////////////////////////////////
V3_RTMapDlg *V3_RTMapDlg::GetInstance( void )
//////////////////////////////////////////////////////////////////////////////////////////
//  Returns the side menu instance.
//////////////////////////////////////////////////////////////////////////////////////////
{
    static V3_RTMapDlg instance;
    return &instance;
}

//////////////////////////////////////////////////////////////////////////////////////////
void V3_RTMapDlg::Draw(V2SPRITEFX *vsfFX)
{
...
BOOL V3_RTMapDlg::CreateRTMap(WORD* pMap,USHORT xPos,USHORT yPos,USHORT World)
{
   ...
   int yy = (ySd*2);
   int xx = 0;
   for(y=0 ; y<RT_VIEW_Y2-ySd ; y++,yy+=2)
   {
      xx = (xSd*2);
...
void V3_RTMapDlg::LoadMapZone(BYTE *pMap,BYTE *pData,int dwX, int dwY,int dwW,int dwH)
{
...
HRESULT V3_RTMapDlg::CreateMapMask (BYTE *pData,int ptMap[15][11],int dwW,int dwH)
{
   memset(pData,0x00,dwW*dwH);
...
int V3_RTMapDlg::SaveCurrentImage8(BYTE *pshImage,BYTE *pPal,int dwWidth, int dwHeight,char *pstrName,BOOL bFlipV)
{
