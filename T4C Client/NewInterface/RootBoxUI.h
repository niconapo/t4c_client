...
public:
    ...
    GameUI * GetDragUI(){return m_puiDragging;}
    void     SetDragUI(GameUI * pDragUI)
    {
       m_puiDragging = pDragUI;
    ...
    bool IsGUIMaximized( void );

	void SetSideMenuState(  bool bLoadCC );
