...
public:
    ...
    void SetGridDef(int iOX, int iOY,int iBtnW,int iRX1,int iRY1,int iRX2,int iRY2,GraphUI *pSUp,GraphUI *pSDown);
...
public:
    ...
    void DropItem( MousePos mousePos ,bool bResetMouseCursor = true);
