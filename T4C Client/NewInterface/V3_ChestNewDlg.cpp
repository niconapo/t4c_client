...
//////////////////////////////////////////////////////////////////////////////////////////
V3_ChestNewDlg *V3_ChestNewDlg::GetInstance( void )
//////////////////////////////////////////////////////////////////////////////////////////
//  Returns the side menu instance.
//////////////////////////////////////////////////////////////////////////////////////////
{

    static V3_ChestNewDlg instance;
    return &instance;
    
} 

unsigned int V3_ChestNewDlg::Display( void *null)
{
...
void V3_ChestNewDlg::UpdateAllFramePos(int iPosX,int iPosY)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
void V3_ChestNewDlg::Draw(V2SPRITEFX *vsfFX)
{
   if(!IsShown())
      return;
   ...
   //Draw All header
   TextOut(hdc,iOffX+68, iOffY+30,g_GUILocalString[96],strlen(g_GUILocalString[96]));
   //reset Text
...
void V3_ChestNewDlg::StartDragDlg( MousePos mousePos )
{
...
void V3_ChestNewDlg::StopDragDlg()
{
   if(m_bDragDialog)
   {
      POINT mousePos;
...
///////////////////////////////////////////////////////
void V3_ChestNewDlg::DragEvent::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
   
   me->StopDragDlg();
}

void V3_ChestNewDlg::DragEvent::StartDragLButtonDown( int mX, int mY )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::UpdateItemList(std::vector< cItemChest > &ItemList)
{
   CAutoLock theLock( RootBoxUI::GetInstance()->GetLock() );
   ...
   {
      V3_ChestNewDlg::cItemChest ItemC;
...
void V3_ChestNewDlg::UpdateSelectedEquip(int iID,bool bSearch, std::string strSearch)
{
   CAutoLock lock( RootBoxUI::GetInstance()->GetLock() );
...
void V3_ChestNewDlg::ChestListEvent::LeftClicked( void )
{
   CAutoLock lock( RootBoxUI::GetInstance()->GetLock() );
...
void V3_ChestNewDlg::ChestListEvent::RightClicked( void )
{
   CAutoLock lock( RootBoxUI::GetInstance()->GetLock() );

   V3_ChestNewDlg *AHUI = static_cast< V3_ChestNewDlg * >( GetUI() );
}

void V3_ChestNewDlg::TabEvent00::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent01::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent02::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent03::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent04::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent05::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent06::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent07::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent08::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent09::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent10::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent11::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent12::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent13::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent14::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::TabEvent15::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::StatGoldChestBtnEvent::LeftClicked( void )
{
   V3_ChestNewDlg *me = static_cast< V3_ChestNewDlg * >( GetUI() );
...
void V3_ChestNewDlg::ResetOngletSelect()
{
...
void V3_ChestNewDlg::SetOngletSelect(int iID)
{
   switch(iID)
   {
...
void V3_ChestNewDlg::AskValueReturn(bool bOK,UINT uiShowCodeP,char *pStrValue1,char *pStrValue2,VKey vKey)
{
   if(!bOK)
      return;
...
void V3_ChestNewDlg::ChestGridEvent::Dragged( void )
{
   ItemUI *item;
   if( GetDragItem() == NULL )
   {
...
void V3_ChestNewDlg::ChestGridEvent::RightClicked(void)
{
   V3_ChestNewDlg *me = V3_ChestNewDlg::GetInstance();
...
bool V3_ChestNewDlg::ChestGridEvent::Dropping( void )
{
...
void V3_ChestNewDlg::AskValueReturnSld(bool bOK,UINT uiShowCodeP,char *pStrValue1,int iSldVal)
{
   if(!bOK || iSldVal == 0)
      return;
...
void V3_ChestNewDlg::RequestMoveItemFromChestToBackpack(DWORD dwItemID,DWORD dwQty)
{
   TFCPacket packet;
...
void V3_ChestNewDlg::RequestMoveItemFromBackpackToChest(DWORD dwItemID,DWORD dwQty)
{
   TFCPacket packet;
...
void V3_ChestNewDlg::UpdateEquipDropZone(int iListPos)
{
