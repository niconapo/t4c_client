...
public:
    ...
    virtual HRESULT DrawSpriteN(LONG x, LONG y, LPV2SPRITEFX vsfFX = NULL ,CV2Sprite *pSprMask = NULL)
    {
    ...
    virtual void DrawSprite(int xPos, int yPos, RECT *Clip, RECT *OutBound, RECT *Wrap, LPDIRECTDRAWSURFACE7 ToBlit = lpDXDirectDraw->GetBackBufferDirect(), char FX = 0, signed char Format = 0, BOOL ParamDither = FALSE)
    {
