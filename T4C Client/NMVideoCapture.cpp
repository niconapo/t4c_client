...
void NMVideoCapture::StartCapture()
{
   ...
   char strTmp[100];
   sprintf_s(strTmp,100,"C:\\Video%03d",m_dwVideoCount);
   m_dwVideoCount++;
...
void NMVideoCapture::CaptureFrame()
{
   ...
   DXDGetDC(&hDcWindow, 4); //Capture screen
   ...
   { 
      ...
      sprintf_s(strFileName,100,"C:\\Video%03d\\img%05d.bmp",m_dwVideoCount-1,m_dwNbrCnt++);
