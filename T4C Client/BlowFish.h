...
{
public:
   EncryptionInterface(const char *pwd) { strncpy_s(_encryptionKey,100, pwd, 99); _encryptionKey[99] = 0; }
...
public:
   ...
   bool ReadEncryptedFile(char* _szFIn, char **ppDecryptedData,unsigned int &iBuffSize, char **pStrVersion_, int &iTextSize_);
