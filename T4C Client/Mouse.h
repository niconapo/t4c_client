...
class CMouseCursor 
{
   private:
      CV2Sprite *vsfCursor;
      CV2Sprite *vsfCursorA;
      CV2Sprite *vsfCursorOld;
      CV2Sprite *vsfCursorOldA;
      bool correction;
      int iXCor;
      int iYCor;
      bool m_bGUIForced;
   ...
   public:
      CMouseCursor(void);
      ~CMouseCursor(void);
      void SetCustomCursor(CV2Sprite * vsf = NULL, int x = 0, int y = 0, bool correction = false ,bool bGUIForced = false, CV2Sprite *ccA = NULL);
      CV2Sprite * GetCustomCursor();
      CV2Sprite * GetCustomCursorA();
