...
int SmoothTile::Load( std::ifstream& rInputStream )
{
...
int SmoothTile::Save( std::ofstream& rOutputStream ) const
{
...
int SmoothTile::TileDefinition::CreateFrom(const std::vector<unsigned short>& rTiles, unsigned short SmoothSize)
{
   ...
   m_Tiles.resize(eTileSignatureSize);
   for (i = 0; i < rTiles.size(); ++i)
   {
...
int SmoothTile::TileDefinition::Load( std::ifstream& rInputStream )
{
...
int SmoothTile::TileDefinition::Save( std::ofstream& rOutputStream ) const
{
