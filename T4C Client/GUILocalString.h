...
// Class that load and provide localized string.
	...
	private:
		...
		void LoadAllStrings( int dwLanguage,bool bGUI); // Load all string in file.
	...
	public:
		...
		void CreateLang( int dwLanguage,bool bGUI);  // Open Local String file and put all string into memory.
...
extern GUILocalString g_LocalString;
