...
public:
    ScrollUI()
        :   listSize( 0 ),
            ...
            */
    {
        //defaultScroll.SetSpriteId( "V3_VSliderTick" );
        defaultScroll.SetSpriteId( "V3_VSliderTickA",true,"V3_VSliderTickAMask" );
        defaultScroll.SetPos( FramePos( 0, 0, 16, 20 ) );
        defaultScroll.Show();
    ...
    void HideTick(){ defaultScroll.Hide();}
