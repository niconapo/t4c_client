...
#define NB_FILESORI 20
#define NB_FILESNMS 20
#define NB_FILEST   NB_FILESORI+NB_FILESNMS
...
//
   public:
      ...
      void  LoadSprite_BFZ(LPV2SPRITEINFO *, LPDATAHEADER ii,LPCTSTR lpszID,LPBYTE lpPal, int iPalIndex, int dwDataCompIndex);	// Load a g_V2Database.LoadSprite No Color Keying.
   ...
   public:
      ...
      bool       m_bDataBufferLoaded[NB_FILEST];
